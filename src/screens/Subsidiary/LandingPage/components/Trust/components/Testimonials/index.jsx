...
const reviews = [
    ...
    {
        user: 'Louis',
        description: 'This app has helped me improve my lifestyle and improve my life. I try to eat on time every day, exercise, take vitamins, and do comprehensive hygiene/beauty. This is the first time I have truly achieved the goal of self-care, and most importantly, because of this application, my mental health, self-confidence and happiness are all very good. Thanks to the developers and everyone who participated in the application❤'
    },
    {
        user: 'Alexandra',
        description: 'I love this app so much! It help me with anxiety and never fails to make me feel better, this app has been a lifesaver and I am thankful to have found it! My gratitude to whoever made this.'
    },
    {
        user: 'Antony',
        description: 'This app has allowed me to take a big leap into dealing with my depression. That is not all though it also offers help for many difficult emotions and even anxiety and as I said depression. It allows you to set goals and it allows you to choose what you need help with. It can help with so many things.'
    },
    {
        user: 'Aron',
        description: 'This app is amazing, they really worked hard on it. This app personalized my self care actvivtes and everything. It also has a calm aestetic. It is simple to work through and calming. I definitely suggest this app for you.'
    },
    {
        user: 'Robert',
        description: 'this is the best free self care app out there. i tried plenty other apps & this is the first one that actually makes me feel better. the visuals are calming plus the activities seem well planned out!'
    },
    {
        user: 'Lenard',
        description: `This is the best app I have ever come across its really gives you the sense of being aware and makes you happier it's the best thing to rejuvenate and get back yourself in high life condition many thanks to the app creater team`
    },
    {
        user: 'Clara',
        description: 'Love it love it love it!!! Thank you so much for the hardwork and love you guys put into the app!!! This is helping me recover from crippling depression caused by C-PTSD. Thank you so much for the app and I hope you guys keep up the good work, it has lots of potential waiting to flourish!!'
    },
    {
        user: 'Travis',
        description: 'Great app! Makes me feel much better focusing on what good things I did today, encouraging me to do the other options so that I can tick them off too, and gives me a break to reflect. Would definitely recommend! Cute app, works really well :)'
    },
    {
        user: 'Zach',
        description: `I love this app a lot. Comparing it to other apps, I think that this one is the most easy to use and also has a really nice and soothing design. I really recommend trying it out if you're looking for something to help you on your path of improvement.`
    },
    {
        user: 'Sophie',
        description: 'Absolutely love it! The app is constantly evolving and they are adding new features. Its great to see the evolution.'
    }
]
