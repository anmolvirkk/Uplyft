                    ...
                    return (
                        <div key={i} className={styles.card}>
                            ...
                            <div className={styles.content}>
                                ...
                                <p>{item.about}</p>
                                <hr />
                                {type!=='main'?<Link className={styles.cta} to={`/signup`}>Try for free</Link>:item.name==='schedule'||item.name==='journals'?<Link className={styles.cta} to={`/${company[item.name]}`}>Learn more</Link>:<div className={`${styles.cta} ${styles.comingsoon}`}>Coming Soon</div>}
                            </div>
                        </div>
                    )
                })}
